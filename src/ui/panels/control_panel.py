...
# Import UnitType enum - this may need to be adjusted based on your project structure
try:
    from core.models.unit_types import UnitType
except ImportError:
    # Fallback enum definition if import fails
    from enum import Enum
    class UnitType(Enum):
        HEROMANCER = "Heromancer"
        UBERMENSCH = "Ubermensch" 
        SOUL_LINKED = "Soul Linked"
        REALM_WALKER = "Realm Walker"
        WARGI = "Wargi"
        MAGI = "Magi"
